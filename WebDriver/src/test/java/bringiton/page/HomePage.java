...
public class HomePage {
    ...
    public HomePage setPasteSyntax(String syntax) {
        WebElement syntaxHighlighting = new WebDriverWait(driver, 5).until(ExpectedConditions.
                elementToBeClickable(By.id("select2-postform-format-container")));
        syntaxHighlighting.click();
        WebElement syntaxBox = driver.findElement(By.id("select2-postform-format-results"));
        syntaxBox.findElement(By.xpath("//li[text()='" + syntax + "']")).click();
        return this;
    }
